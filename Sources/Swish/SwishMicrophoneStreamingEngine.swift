//
//  MicrophoneStreamingEngine.swift
//  SwishDemo
//
...
public class SwishMicrophoneStreamingEngine: SwishStreamingEngine {
    ...
    func setupAndStartEngine(
        ...
        guard let inputNode = inputNode else {
            throw SwishError.engineNotInitialized
        }
        ...
        guard inputFormat.sampleRate > 0 else {
            throw SwishError.zeroInputSampleRate
        }
        ...
        guard
            ...
            throw SwishError.nilOutputAudioFormat
        }
